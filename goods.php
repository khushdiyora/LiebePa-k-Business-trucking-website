<head>
    ...
    <title>Import & Export of goods Page.</title>
    <link
      rel="shortcut icon"
      href="img/logo.png"
      sizes="16x16 32x32"
        ...
        <div class="container-fluid">
          ...
          <a id="menu-close" href="#"><i class="fa fa-times"></i></a>
			...
			<div class="bg-image page-title">
				<div class="container-fluid">
					<a href="#"><h1>Import & Export of goods</h1></a>
					<div class="pull-right">
						<a href="index.html"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">Our services</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="goods.php">Import & Export of goods</a>
					</div>
				</div>
			</div>
	...
	<div class="col-sm-3">
                  ...
                  <li>
					...
					<div class="col-sm-9 main-content">
						...
						<img src="media/images/10.png" class="full-width wow zoomIn rounded " data-wow-delay="0.3s" alt="Img">
						<div class="row">                    	
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <p>The increased trade between countries has significantly stimulated the import and export of goods. Palush Logistics offers comprehensive solutions to facilitate the seamless movement of goods to and from destinations such as Canada, Bharat, Europe, and COMESA countries, accessible through the Port of Mombasa, Kenya.</p>
								
								<img src="media/images/12.jpg" class="full-width rounded" alt="Img">
								<h4>IMPORT AND EXPORT GOODS</h4>
							...
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <h4>What we offer</h4>
                                <p>Palush Logistics provides a comprehensive and efficient transportation network for the import and export of goods within Canada, Bharat, Europe, and other global destinations. Our services include:</p>
                                <ul class="fa-ul">
    <li>
        <span class="fa-li"><i class="fas fa-long-arrow-alt-right"></i></span>
        Handling of Full Container Loads (FCL) and Less than Container Loads (LCL)
    </li>
    <li>
        <span class="fa-li"><i class="fas fa-long-arrow-alt-right"></i></span>
    ...
    <li>
        <span class="fa-li"><i class="fas fa-long-arrow-alt-right"></i></span>
        Transport of Fragile and Sensitive Goods
    </li>
    <li>
        <span class="fa-li"><i class="fas fa-long-arrow-alt-right"></i></span>
        Courier Express Delivery with a Quick Turnaround
    </li>
</ul>

								<img src="media/images/13.jpg" class="full-width rounded" alt="Img">
								<h4>TIMELY DELIVERY</h4>
								<p>Our operations are guided by a commitment to timeliness, and we endeavor to work closely with clients to ensure the on-time delivery of goods.
