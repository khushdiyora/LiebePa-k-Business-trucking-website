			...
			<div class="bg-image page-title">
				<div class="container-fluid">
					...
					<div class="pull-right">
						<a href="index.html"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">Our services</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="road-trucking.php">Road trucking</a>
					</div>
				</div>
			</div>
	...
	<div class="col-sm-3">
                  ...
                  <li>
					...
					<div class="col-sm-9 main-content">
						...
						<img src="media/images/6.jpg" class="full-width wow zoomIn rounded " data-wow-delay="0.3s" alt="Img">
						<div class="row">                    	
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <p>The increased trade between countries has stimulated haulage by road. Goods can be carried from door to door within Canada, Bharat, Europe and Comesa countries accessible by road from the Port of Mombasa, Kenya. </p>
                                <p>Palush Logistics prides itself in its ability to offer efficient transport solutions using its fleet of trucks. Our trucks are fitted with a Real-time Satellite Tracking over digital maps, which allow the management to view the fleet location over the Internet based on GPS through IDEN/GSM Communication System. This device ensures that the trucks position is known all the time.</p>
								
								<img src="media/images/4.jpg" class="full-width rounded" alt="Img">
                                ...
                                <p> Palush ensures that sourcing of goods is done with utmost professionalism taken into consideration to ensure that the correct goods and services are delivered.</p>
								
							</div>
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <h4>What we offer</h4>
                                <p>Palush Logistics provides a reasonable yet comprehensive transportation network within Canada, Bharat, Europe and will be in a position to handle the following:</p>
								<ul class="fa-ul">
                            <li>
                            ...
                            <li>
								...
								<img src="media/images/5.jpg" class="full-width rounded" alt="Img">
