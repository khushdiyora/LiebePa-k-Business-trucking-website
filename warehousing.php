			...
			<div class="bg-image page-title">
				<div class="container-fluid">
					...
					<div class="pull-right">
						<a href="index.html"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">Our services</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="warehousing.php">Warehousing</a>
					</div>
				</div>
			</div>
	...
	<div class="col-sm-3">
                  ...
                  <li>
					...
					<div class="col-sm-9 main-content">
						...
						<img src="media/images/8.jpg" class="full-width wow zoomIn rounded " data-wow-delay="0.3s" alt="Img">
						<div class="row">                    	
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <p>The increased trade between countries has significantly stimulated the need for efficient warehousing solutions. Palush Logistics offers comprehensive warehousing services to support the seamless movement and storage of goods to and from destinations such as Canada, Bharat, Europe, and COMESA countries, accessible through the Port of Mombasa, Kenya.</p>
								
								<img src="media/images/14.png" class="full-width rounded" alt="Img">
								<h4>WAREHOUSING SERVICES</h4>
								<p>Optimal Storage Solutions</p>
                                <p> Modern warehousing practices, combined with improved compliance, can lead to significant efficiencies and cost savings. Palush ensures that the storage and handling of goods are managed with utmost professionalism, ensuring that the correct goods and services are delivered and stored efficiently.</p>
								
							</div>
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <h4>OUR WAREHOUSING CAPABILITIES</h4>
                                <p>alush Logistics provides a comprehensive and efficient warehousing network for clients within Canada, Bharat, Europe, and other global destinations. Our services include:</p>
								<ul class="fa-ul">
                            <li>
                                <i class="fa fa-li fa-long-arrow-right"></i>
                                Storage for Full Container Loads (FCL) and Less than Container Loads (LCL)
                            </li>
                            ...
                            <li>
                                <i class="fa fa-li fa-long-arrow-right"></i>
                                Handling of Bulk and Heavy Lift Project Cargo
                            </li>

                            <li>
                                <i class="fa fa-li fa-long-arrow-right"></i>
                                Secure Storage for Fragile and Sensitive Goods

                            <li>
                                <i class="fa fa-li fa-long-arrow-right"></i>
                                Efficient Inventory Management and Express Courier Delivery
                            </li>
                           
                        </ul>
							
								<img src="media/images/15.jpg" class="full-width rounded" alt="Img">
								<h4>COMMITMENT TO EFFICIENCY</h4>
								<p>Our warehousing operations are guided by a commitment to efficiency and client satisfaction. We work closely with clients to ensure that goods are stored and managed effectively, facilitating smooth and timely distribution.</p>
