...
toggleArea.addEventListener("click", function (e) {
  ...
  if (toggleArea.classList.contains("monthly")) {
    ...
    basicPrice.innerHTML = `<p class="price-1"> <span class="dollar-sign">&dollar;</span>1999.99</p>`;
    profPrice.innerHTML = `  <p class="price-2"> <span class="dollar-sign">&dollar;</span>2249.99</p>`;
    masterPrice.innerHTML = `  <p class="price-3"> <span class="dollar-sign">&dollar;</span>3399.99</p>`;
  } else {
    ...
    profPrice.innerHTML = `  <p class="price-2"> <span class="dollar-sign">&dollar;</span>244.99</p>`;
