			...
			<div class="bg-image page-title">
				<div class="container-fluid">
					...
					<div class="pull-right">
						<a href="index.html"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">Our services</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="air-freight.php">Air Freight</a>
					</div>
				</div>
			</div>
	...
	<div class="col-sm-3">
                  ...
                  <li>
					...
					<div class="col-sm-9 main-content">
						...
						<img src="media/images/7.jpg" class="full-width wow zoomIn rounded " data-wow-delay="0.3s" alt="Img">
						<div class="row">                    	
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <p>The increased trade between countries has significantly boosted air freight transportation. Goods can be shipped quickly and efficiently to destinations around the world, including Canada, Bharat, Europe, and COMESA countries, thanks to modern air transport networks.</p>
                                <p>Palush Logistics prides itself on offering efficient air transport solutions using its fleet of aircraft and strategic airline partnerships. Our services include Real-time Satellite Tracking over digital maps, allowing management to monitor shipments' location over the Internet using GPS and IDEN/GSM Communication Systems. This technology ensures that the exact position of shipments is known at all times.</p>
								
								<img src="media/images/9.png" class="full-width rounded" alt="Img">
                                ...
                                <p> Modern procurement practices, with improved compliance, can lead to significant savings. Palush ensures that the sourcing of goods is handled with utmost professionalism, ensuring that the correct goods and services are delivered efficiently.</p>
								
							</div>
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <h4>What we offer</h4>
                                <p>Palush Logistics provides a comprehensive and efficient air transportation network within Canada, Bharat, Europe, and other global destinations. Our services include:</p>
								<ul class="fa-ul">
                            <li>
                                <i class="fa fa-li fa-long-arrow-right"></i>
                                Air Freight for Full Container Loads (FCL) and Less than Container Loads (LCL)
                            </li>
                            ...
                            <li>
                                <i class="fa fa-li fa-long-arrow-right"></i>
                                Handling of Fragile and Sensitive Goods
                            </li>

                            <li>
                                <i class="fa fa-li fa-long-arrow-right"></i>
                                ourier Express Delivery with Rapid Turnaround Times
                            </li>
                           
                        </ul>
							
								<img src="media/images/11.jpg" class="full-width rounded" alt="Img">
								<h4>TIMELY DELIVERY</h4>
								<p>Our operations are guided by a commitment to timeliness, and we endeavor to work closely with clients to ensure on-time delivery.</p>
          ...
          <div class="row block-content">
            ...
            <div class="col-sm-2 wow zoomIn" data-wow-delay="0.3s">
              ...
              <nav>
                ...
                <a href="track.php">Track Your Shipment</a>
              </nav>
            </div>
            <div class="col-sm-4 wow zoomIn" data-wow-delay="0.3s">
              <h4>CONTACT INFO</h4>
