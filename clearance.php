  <head>
    ...
    <meta
      name="description"
      content="Trucking is transportation and Logistics website Canada, Bharat, Europe, "
    />
			...
			<div class="bg-image page-title">
				<div class="container-fluid">
					...
					<div class="pull-right">
						<a href="index.html"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">Our services</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="clearance.php">Clearance and forwading</a>
					</div>
				</div>
			</div>
	...
	<div class="col-sm-3">
                  ...
                  <li>
					...
					<div class="col-sm-9 main-content">
						...
						<img src="media/images/3.png" class="full-width wow zoomIn rounded" data-wow-delay="0.3s" alt="Img">
						<div class="row">                    	
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
								<p>Customs clearance is all about simplicity. Customs rules and processes can be confusing in Canada, Bharat, Europe but our goal is make customs brokerage as easy as possible for you.</p>
